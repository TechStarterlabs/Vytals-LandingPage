      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="mt-1 text-base text-gray-900">{batch.batch_code}</p>
          </div>
          
          <div>
            <label className="text-sm font-medium text-gray-500">Product</label>
            <p className="mt-1 text-base text-gray-900">{batch.product_name}</p>
          </div>
          
          <div>
            <label className="text-sm font-medium text-gray-500">Quantity</label>
            <p className="mt-1 text-base text-gray-900">{batch.quantity}</p>
          </div>
          ...
          <div>
            <label className="text-sm font-medium text-gray-500">Manufactured Date</label>
            <p className="mt-1 text-base text-gray-900">{batch.manufactured_date}</p>
          </div>
          
          <div>
            <label className="text-sm font-medium text-gray-500">Expiry Date</label>
            <p className="mt-1 text-base text-gray-900">{batch.expiry_date}</p>
          </div>
          
          <div>
            <label className="text-sm font-medium text-gray-500">Created Date</label>
            <p className="mt-1 text-base text-gray-900">{batch.created_at}</p>
          </div>
        </div>
      </div>
    </div>
